...
public class BookTransactionManager {
    ...
    public boolean issueBook(int rollNo, int isbn){
        ...
        BookTransaction book_trantransaction = new BookTransaction(isbn,rollNo,issue_date, null);
        book_transaction_list.add(book_trantransaction);
...
public void writeToFile(){
    ...
    public void showAll(){
        for(BookTransaction book_traTransaction:book_transaction_list)
            System.out.println(book_traTransaction);
    }
